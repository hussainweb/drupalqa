...
This image currently only supports Debian along with PHP 7.1 and PHP 7.2. Once the base PHPQA image adds support for PHP 7.3, I will add it here as well.
